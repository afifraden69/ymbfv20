...
# LO KONTOL
logo = ''' \033[0;96m __________             _____ _____________________
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By Muhamad Badru Wasih
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| Github.com/Dru-Crack23
 \033[0;96m  /_/       /_/  /_/____/_/ \033[0;91mv2.0  \033[0m|| Facebook.com/Bang.badru23'''
# crack selesai
def hasil(ok,cp):
...
def yayanxd():
	...
	try:
		...
		time.sleep(2)
		raw_input(' %s*%s tekan enter '%(O,N))
		os.system('xdg-open https://api.whatsapp.com/send?phone=628811403654&text=Halo%0ABang%20says%20Pengguna%20Ymbf')
		kontol()
	except KeyError:
